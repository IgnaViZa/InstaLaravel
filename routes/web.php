...
Route::get('/perfil','App\Http\Controllers\UserController@getPerfil')->name('perfil');
Route::get('/perfil/{id}','App\Http\Controllers\UserController@getProfile')->name('profile');
